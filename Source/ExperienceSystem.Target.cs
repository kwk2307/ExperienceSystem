...
public class ExperienceSystemTarget : TargetRules
{
	public ExperienceSystemTarget(TargetInfo Target) : base(Target)
	{
	...
	internal static void ApplySharedLyraTargetSettings(TargetRules Target)
	{
		...
		if (Target.BuildEnvironment == TargetBuildEnvironment.Unique)
		{
			...
			ExperienceSystemTarget.ConfigureGameFeaturePlugins(Target);
		}
		else
		{
			// !!!!!!!!!!!! WARNING !!!!!!!!!!!!!
